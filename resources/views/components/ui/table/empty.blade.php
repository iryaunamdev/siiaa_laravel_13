...
<tr>
    <td colspan="{{ $colspan }}"
        {{ $attributes->merge([
            'class' => 'px-[var(--table-cell-x)] py-10 text-center text-[length:var(--table-text)] text-zinc-500',
        ]) }}>
        <div class="flex flex-col items-center justify-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-zinc-300" viewBox="0 0 20 20" fill="currentColor"
                aria-hidden="true">
